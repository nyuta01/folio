...
([ADR-0006](/folio/reference/adrs/)). Either every record in the batch lands or
...
- [`folio delete`](/folio/cli/delete/) — remove rows by primary key.
- [`folio materialize`](/folio/cli/materialize/) — fill `x-derived` fields.
- [Edit permissions](/folio/sheet/editable-by/) — patterns and edge cases.
