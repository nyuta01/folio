...
([ADR-0003](/reference/adrs/)) so external tools — `datacontract-cli`,
...
- [records.jsonl](/sheet/records/) — what valid rows look like.
- [Edit permissions](/sheet/editable-by/) — patterns and edge cases for
  `x-editable-by`.
- [Reference: contract.yaml spec](/reference/contract-spec/) — the exhaustive
