...
A `.lock` file in the sheet serializes writers (single-writer, [ADR-0006](/folio/reference/adrs/)).
...
Folio layer ([ADR-0005](/folio/reference/adrs/)). Use `upsert_records` and
