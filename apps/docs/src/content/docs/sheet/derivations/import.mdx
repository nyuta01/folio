...
Pick [`cross_sheet`](/folio/sheet/derivations/cross-sheet/) when both sides are
...
- [`cross_sheet`](/folio/sheet/derivations/cross-sheet/) — for sheet-to-sheet
  references.
- [`folio export datapackage`](/folio/cli/export/) — go the other way; export the
