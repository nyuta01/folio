...
[`StubAIClient`](/sdk/ai-client/) pattern.
...
- [HTTP transport SDK reference](/sdk/http-transport/) — Protocol, adapters,
  test patterns.
- [Materialize lifecycle](/get-started/materialize-lifecycle/) — how the
