...
- **No cache files.** The cache lives at
  `<user-cache>/folio/<sheet-id>/cache/`. See [ADR-0008](/reference/adrs/).
...
[ADR-0006](/reference/adrs/)). All write operations — `upsert_records`,
...
Failures are reported per record × field on the [`§10.6 envelope`](/cli/materialize/),
