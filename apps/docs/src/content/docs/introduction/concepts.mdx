...
[contract.yaml spec](/reference/contract-spec/).
...
See [ADR-0008](/reference/adrs/) for the rationale.

## Surfaces

Same sheet, four interfaces:

- [**CLI**](/cli/overview/) (`folio`) — for shell scripts and humans.
- [**Python SDK**](/sdk/overview/) (`folio`) — for application code and tests.
- [**MCP server**](/mcp/overview/) (`folio-mcp`) — exposes the SDK as MCP
  tools so agents speak it through standard runtimes.
- [**Viewer**](/viewer/overview/) (`folio-viewer`) — local-only FastAPI +
