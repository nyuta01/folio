...
Skills surface uniformly through `folio skill list/show/run` and
`Sheet.list_skills`. See the [Sheet skills specification](/folio/sheet/skills/).
...
All three are thin wrappers over the same Python SDK and read/write the same
files.
