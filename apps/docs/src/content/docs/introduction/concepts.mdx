---
title: Concepts
description: Sheet, contract, records, derivations, skills, provenance, actor — the vocabulary used everywhere else.
---
...
Skills surface uniformly: `folio skill list/show/run`, `Sheet.list_skills`,
and MCP prompts named `<sheet-id>:<skill-name>`. See the
[Sheet skills specification](/folio/sheet/skills/).
