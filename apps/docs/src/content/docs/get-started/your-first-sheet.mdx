...
Tell Folio how to derive `country_code`. We'll use the [`python` kind](/sheet/derivations/python/)
...
- [Materialize lifecycle](/get-started/materialize-lifecycle/) — what the
  cache really keys on, when it invalidates, and how to force a rerun.
- [Editing and provenance](/get-started/editing-and-provenance/) — what
  happens when humans and agents touch the same field.
- [Derivations overview](/sheet/derivations/overview/) — the other five
