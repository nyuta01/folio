...
[`open_sheet`](/sdk/open-sheet/) and call any of the methods below.
...
statements raise `QueryError` ([ADR-0005](/reference/adrs/)).
...
Run derivations. Returns the [§10.6 envelope](/cli/materialize/):
