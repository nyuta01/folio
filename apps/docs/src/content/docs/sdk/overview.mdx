...
See [Errors](/sdk/errors/) for which method raises which exception.
...
writers ([ADR-0006](/reference/adrs/)). Reads do not take the lock and
...
- [`open_sheet`](/sdk/open-sheet/) — constructor details and edge cases.
- [Sheet API](/sdk/sheet-api/) — every method with signatures and examples.
- [AI client](/sdk/ai-client/) — Protocol, adapter, stub.
- [HTTP transport](/sdk/http-transport/) — Protocol, adapter, stub.
- [Errors](/sdk/errors/) — full exception reference.
