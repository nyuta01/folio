...
Nine tools, all wrappers over the SDK ([Tools reference](/mcp/tools/)):
...
- [Tools](/mcp/tools/) — the nine tools, with arguments and return shapes.
- [Deploy](/mcp/deploy/) — Claude Desktop config, HTTP transport, security
  notes.
